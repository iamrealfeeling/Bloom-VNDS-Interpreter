...
Это оптимизированный(нет, ну немножко да) интерпретатор визуальных новелл для PlayStation Portable на базе Lua, созданный для запуска новелл созданных под VNDS, гибким конфигом и полной поддержкой русского языка.
